...
hl.bind(mainMod .. " + SHIFT + ALT + S", hl.dsp.window.move({ workspace = "special" }))
hl.bind(mainMod .. " + S",         hl.dsp.workspace.toggle_special())


-- HUZ_MULTI_RICE_GLOBAL_BINDS
-- Shared controls used across every Multi-Rice profile.
...
hl.bind(
    "SUPER + SHIFT + R",
    hl.dsp.exec_cmd(huzHome .. "/.local/bin/refresh-switch")
)
