...
// Original: https://github.com/Keyitdev/sddm-astronaut-theme
...
//
// ATTRIBUTION REQUIRED: Any redistribution must maintain this copyright notice
// and give appropriate credit to the original author (moau-prog).
